            ...
            <div className='grid h-[82vh]'>
                ...
                <div className='relative'>
                    <ReactPlayer
                        ...
                        height='40rem'
                    />
                    <div className='absolute grid right-0 left-0 bottom-0 top-0 mr-4 justify-items-center top-1/5 gap-6 z-10 justify-end'>
                        <div className='grid'>
                            <div className=''>
                                <GiTrade
                                    onClick={handleStart}
                ...
                <div
                    className='w-full h-full bg-black bg-opacity-80 absolute top-0 bottom-0 left-0 right-0'
