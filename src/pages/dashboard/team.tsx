    ...
    return (
        <div className='h-[80vh]'>
            <div className='py-5 px-2 grid'>
                ...
                >
                    <form className='px-10 py-8 grid justify-center'>
                        <div className=' grid justify-items-center gap-4 dark:text-[#1a1a2d]'>
                            ...
                            <p className='text-2xl py-4 px-6 border border-orange-400 font-bold rounded-lg'>
                                Portfolio
                            </p>
                        </div>
                        <button className='bg-green-600 font-semibold py-2 px-4 justify-self-center rounded-lg mt-5'>
                            Transfer
                        </button>
                    </form>
                </div>
